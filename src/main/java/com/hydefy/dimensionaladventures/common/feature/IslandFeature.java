...
public class IslandFeature extends Feature<BlockStateConfiguration> {
    public IslandFeature(Codec<BlockStateConfiguration> p_66017_) {
        super(p_66017_);
    }
        ...
        for(int k = -i; k < i; ++k) {
            for(int l = -i; l < i; ++l) {
                ...
                if (d0 < 0.0D) {
                    ...
                    if (isIcebergState(blockstate) || blockstate.is(BlockInit.FEATHER_GRASS_BLOCK.get())) {
                        if (p_66040_) {
