...
public class ChikoModel<Type extends Entity> extends QuadrupedModel<Type> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(DimensionalAdventures.MODID, "chiko"), "main");
	public ChikoModel(ModelPart p_170515_) {
